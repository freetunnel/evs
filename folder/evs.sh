...
echo -e "      \033[0;36mWhatsapp${exitsc} wa.me/6281927625651"
lane
exit
fi
}
...
# REPO
REPO="https://raw.githubusercontent.com/freetunnel/evs/main/"
...
echo "IP=" >> /var/lib/fvstore/ip.conf
...
DATEVPS=$(date +'%d-%m-%Y')
CHATID="1916636450"
KEY="6986990618:AAE9RaNXh2Q7ps8dTTAemqV7e_W2bu9qKUs"
...
<i>FREE TUNNELING PROJECT INSTALL </i>
<code>────────────────────</code>
"'&reply_markup={"inline_keyboard":[[{"text":" ⛈️ BUY HERE ⛈️ ","url":"https://t.me/freetunnelproject"}]]}' 
...
REPO2="https://raw.githubusercontent.com/freetunnel/evs/main/"
cd
